<div class="span-5 prepend-1 last sidebar-single small">
    ...
    <li>
        ...
        <p class="description"><?php the_author_meta('description', get_the_author_id());?></p>
        <p>Find more post by <?php the_author_posts_link(); ?> </p>
		<h2>SHARE THE LOVE</h2>
        <p>If you liked this post then please share it</p>
